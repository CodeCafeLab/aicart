...
const testimonials = [
  {
    ...
    text: "AI Kart turned a weeks-long shoot into minutes. The quality is professional and consistent.",
  },
  {
    name: "Mike T.",
    role: "Fashion Designer",
    avatar: "https://i.pravatar.cc/150?u=a042581f4e29026705d",
    text: "I prototype collections with realistic models and lighting—no studio needed. A game-changer.",
  },
  {
    name: "Elena R.",
    role: "Marketing Director",
    avatar: "https://i.pravatar.cc/150?u=a042581f4e29026706d",
    text: "Animations and concepts created instantly — our campaigns now outpace competitors.",
  },
];
...
const faqItems = [
  {
    question: "What is AI Kart?",
    answer:
      "AI Kart is an AI creative studio for producing high-quality product photography and animations without physical shoots. Upload, style, and generate.",
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-[#060718] to-[#0e152e] text-slate-50">
        ...
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between h-16">
          <div className="flex items-center gap-4">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm text-slate-200">
              <a href="#features" className="hover:text-[#FFB400] transition">
                Features
              </a>
              <a href="#outputs" className="hover:text-[#FFB400] transition">
                Outputs
              </a>
              <a href="#pricing" className="hover:text-[#FFB400] transition">
                Pricing
              </a>
              <a href="#faq" className="hover:text-[#FFB400] transition">
                FAQ
              </a>
            </nav>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              asChild
              className="bg-gradient-to-r from-[#FFB400] to-[#8B5CF6] text-black shadow-xl hover:scale-105"
            >
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10 py-24 md:py-36 text-center">
            ...
            <h1 className="mt-6 text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight tracking-tight">
              AI Kart — AI Studio for{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFB400] to-[#8B5CF6]">
                Product & Apparel Photography
              </span>
            </h1>

            <p className="mt-6 max-w-3xl mx-auto text-lg text-slate-200/80">
              Generate studio-quality images, model shots and animations with AI
              — fast, consistent, and tailored to your brand.
            </p>

            <div className="mt-8 flex items-center justify-center gap-4 flex-col sm:flex-row">
              <Button
                size="lg"
                className="flex items-center gap-3 bg-gradient-to-r from-[#FFB400] to-[#8B5CF6] text-black shadow-2xl transform transition hover:-translate-y-0.5"
              >
            ...
            <div className="mt-10 flex items-center justify-center gap-6 text-sm text-slate-300/70 flex-wrap">
              ...
              <div className="flex items-center gap-4">
                <div className="text-xs px-3 py-1 rounded bg-white/5">
                  ApparelCo
                </div>
                <div className="text-xs px-3 py-1 rounded bg-white/5 hidden sm:block">
                  ModaLab
                </div>
                <div className="text-xs px-3 py-1 rounded bg-white/5 hidden md:block">
                  RetailX
                </div>
              </div>
            </div>
        ...
        <section className="py-8 md:py-14">
          <div className="container mx-auto px-4 md:px-6">
            <div className="rounded-2xl overflow-hidden border border-white/6 shadow-2xl bg-gradient-to-b from-white/3 to-transparent p-1">
              <Image
                src={
                  PlaceHolderImages.find((p) => p.id === "landing-hero-1")
                    ?.imageUrl || "https://picsum.photos/1200/600"
                }
                alt="AI Kart showcase"
                width={1600}
                height={800}
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-bold">
                A full creative suite for product teams
              </h2>
              <p className="mt-4 text-slate-200/80">
                Everything you need to design, light, animate and publish
                product content — all powered by AI.
              </p>
            </div>
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((f) => (
                <Card
                  key={f.title}
                  className="bg-[#071029]/60 border border-white/6 hover:border-[#FFB400]/40 transition"
                >
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4">
                      <Link
                        href={f.href}
                        className="text-sm text-[#FFB400] hover:underline inline-flex items-center gap-2"
                      >
        ...
        <section
          id="outputs"
          className="py-12 md:py-20 bg-gradient-to-b from-transparent to-[#071029]/50"
        >
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold">
                Real outputs from the community
              </h3>
            </div>
        ...
        <section id="pricing" className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-bold">
              Pricing made for creators & teams
            </h2>
            <p className="mt-3 text-slate-200/80 max-w-2xl mx-auto">
              Start for free, upgrade when ready. No long-term commitment.
            </p>
              ...
              {pricingTiers.map((tier) => (
                <Card
                  ...
                  className={`relative flex flex-col ${
                    tier.popular
                      ? "border-2 border-[#FFB400] shadow-2xl bg-gradient-to-b from-[#FFFAED]/5 to-transparent"
                      : "bg-[#071029]/60 border border-white/6"
                  }`}
                >
                  {tier.popular && (
                    <Badge className="absolute left-1/2 -top-3 -translate-x-1/2 bg-[#FFB400] text-black px-3 py-1">
                      Most Popular
                    </Badge>
                  )}
                  <CardHeader>
                  ...
                  <CardContent className="flex-1 flex flex-col">
                    ...
                    <ul className="mt-6 space-y-3 flex-1">
                      {tier.features.map((f) => (
                        <li
                          key={f}
                          className="flex items-start gap-3 text-slate-200/80"
                        >
                    ...
                    <div className="mt-6">
                      <Button
                        ...
                        className={`${
                          tier.popular
                            ? "bg-gradient-to-r from-[#FFB400] to-[#8B5CF6] text-black"
                            : ""
                        } w-full`}
                      >
        ...
        <section
          id="testimonials"
          className="py-12 md:py-20 bg-gradient-to-b from-transparent to-[#071029]/30"
        >
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              {testimonials.map((t) => (
                <Card
                  key={t.name}
                  className="bg-[#071029]/50 border border-white/6"
                >
                  <CardContent>
      ...
      <footer className="border-t border-white/6 bg-[#061024]">
        <div className="container mx-auto px-4 md:px-6 py-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <Logo />
            <p className="mt-4 text-slate-300/80 text-sm max-w-sm">
              AI Kart — Create product photography, model shoots, and animations
              with AI. Faster, cheaper, and consistent.
            </p>
            <div className="mt-4 flex items-center gap-3">
              <Link href="#" className="text-slate-300/70 hover:text-[#FFB400]">
                Terms
              </Link>
              <Link href="#" className="text-slate-300/70 hover:text-[#FFB400]">
                Privacy
          ...
          <div className="flex gap-12 justify-around md:justify-center">
            <div>
              ...
              <ul className="text-sm text-slate-300/80 space-y-2">
                <li>
                  <Link href="/product-mode">Product Mode</Link>
                </li>
                <li>
                  <Link href="/avatars">Avatars</Link>
                </li>
                <li>
                  <Link href="/scenes">Scene Stylist</Link>
                </li>
              </ul>
            </div>
            <div>
